module.exports.pagamento = function(application, req, res){
    ...
    var callback = function(erro,result){
            console.log(result);
            res.render('pagamentos/pagamento.ejs',{pagamentos:result,get:get,obra:obra});;
            };        
...
module.exports.pagamentos = function(application, req, res){  
    ...
    var callback = function(erro,result){
        //console.log(pedidos) ; 
            res.render('pagamentos/pagamentos.ejs',{pagamentos:result, pedidos:pedidos, obra:obra});;
            };        
    pagamentoModel.pagamentos(obra, callback);
}
