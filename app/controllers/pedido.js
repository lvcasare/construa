...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    if (pedidoid==0){
        ...
        var callback = function(erro,result){         
            ...
            res.render('pedidos/pedido.ejs',{pedido:result, produtos:produtosresult, pedidoid:pedidoid,obra:obra});;
            };        
        pedidosModel.carregarPedido(pedidoid, callback)
                ...
                var callback1 = function(erro,result,pedido){
                    ...
                    ///////////////////////////////////////////////////////////////////////
                    res.render('pedidos/pedido.ejs',{itens:result, produtos:produtosresult,pedidobusca:pedidobusca, pedidoid:pedidoid,totalpedido:totalpedido,obra:obra});;
                    };                            
